...
public class LiveRoomActivity extends BaseActivity implements AGEventHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView tv = (TextView) findViewById(R.id.geo);
        tv.setBackgroundColor(Color.WHITE);
        String uuid = Settings.Secure.getString(getContentResolver(), Settings.Secure.ANDROID_ID);
        FirebaseFirestore db = FirebaseFirestore.getInstance();
        final DocumentReference docref = db.collection("position").document(uuid);
        docref.addSnapshotListener(new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(DocumentSnapshot documentSnapshot, FirebaseFirestoreException e) {
                ...
                if (documentSnapshot != null && documentSnapshot.exists()) {
                    ...
                    tv.setText("Latitude: " + d.get("lat") + " Longitude: " + d.get("lon"));
                }
            }
        });
    }
