...
class MyLocationListener implements LocationListener {
    ...
    private String uuid;
    public MyLocationListener(Context mContext, String uuid) {
    ...
    public void onLocationChanged(Location loc) {
        ...
        test.put("lat", latitude);
        test.put("lon", longitude);
//        if (ContextCompat.checkSelfPermission(mContext, Manifest.permission.READ_PHONE_STATE) != PackageManager.PERMISSION_GRANTED) {
//            System.out.println("no perm");
//        }

        db.collection("quads").document(uuid)
                .set(test)
...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)
            ...
            System.out.println("Permission loc");
        ...
        LocationListener locationListener = new MyLocationListener(getApplicationContext(), uuid);
        locationManager.requestLocationUpdates(
                LocationManager.GPS_PROVIDER, 50, 10000, locationListener);
